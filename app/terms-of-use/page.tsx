  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <section className="mb-6">
        ...
        <p>
          We take data security seriously and comply with all relevant regulations. This information will not be
          disclosed to any third parties without the patient&apos;s consent unless required by law or for medical
          purposes.
        </p>
      </section>
    </div>
