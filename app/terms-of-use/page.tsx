  ...
  return (
    <div className="ml-6 mr-12 py-4 mt-4 mb-4">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-2">1.	Purpose of Referral</h2>
          <p>This referral form is intended to facilitate the transfer of patient information 
            ...
            By completing the form, you consent to the sharing of necessary health information 
      ...
      <section className="mb-6">
        ...
        <p>Patient data submitted through the referral form is subject to 
          strict privacy and data protection policies, in compliance with relevant 
          healthcare privacy regulations, HIPAA.</p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p>By submitting this referral form, I confirm that I have read and understood the 
